...
<head>
    ...
    <title>@yield('title', 'Ecom') -Shopping</title>
...
<body class="bg-effect">
    ...
    <header class="pb-md-4 pb-0">
        {{-- Header Top --}}
            @include('frontend.layout.include.header.top')
        {{-- Header Top --}}

        {{-- Header Middle --}}
            @include('frontend.layout.include.header.middle')
        {{-- Header Middle --}}

        {{-- Header Menu --}}
            @include('frontend.layout.include.header.menu')
        {{-- Header Menu --}}
    </header>
    {{-- Header End --}}

    <!-- mobile fix menu start -->
        @include('frontend.layout.include.header.mobile-menu')
    <!-- mobile fix menu end -->
   ...
   {{-- Footer Section Start --}}
        @include('frontend.layout.include.footer.footer')
   {{-- Footer Section End --}}
    ...
    {{-- Cookie Bar Box Start --}}
        @include('frontend.layout.include.modal.cookie')
    {{-- Cookie Bar Box End --}}

    {{-- Deal Box Modal Start --}}
        {{-- @include('frontend.layout.include.modal.deal-box') --}}
    {{-- Deal Box Modal End --}}
